    ...
    <div className="bg-bgpurple -mt-64" id="first-section">
      <div className="mx-auto max-w-2xl pt-64 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className="col-span-4">
            <img src={"/assets/logo/Logo-2.svg"} alt="logo" className="pb-4" />
            ...
            <div className="flex gap-4">
              <Link href="https://tinyurl.com/Instagram-Devrise">
                <img
              ...
              <Link href="https://tinyurl.com/X-Devrise">
                <img
              ...
              <Link href="https://tinyurl.com/Youtube-Devrise">
                <img
      ...
      <div className="pb-24 px-4">
        <h3 className="text-center text-offwhite">
          ...
          <Link href="https://thedevrise/" target="_blank">
            {" "}
            Devrise
          </Link>
        </h3>
