...
const products: Product[] = [
  {
    ...
    imageSrc: "/assets/mentor/Kingsley.png",
    imageAlt: "Front of men's Basic Tee in black.",
    // color: "Shoo Thar Mein",
    color: "Kelechi Onuorah",
  },
  {
    id: 2,
    ...
    imageSrc: "/assets/mentor/Adaeze.png",
    imageAlt: "Front of men's Basic Tee in black.",
    // color: "Cristian Doru Barin",
    color: "Adaeze Ekemefuna",
  },
  {
    id: 3,
    // name: "SEO Expert",
    ...
    imageSrc: "/assets/mentor/Sammy.png",
    imageAlt: "Front of men's Basic Tee in black.",
  ...
  },
  {
    ...
    imageSrc: "/assets/mentor/Chiamaka.png",
    imageAlt: "Front of men's Basic Tee in black.",
    // color: "Andrew Williams",
    color: "Chiamaka Lilian Nwaogu",
  },
  {
    id: 5,
    // name: "Web Development / Web Design",
    ...
    imageSrc: "/assets/mentor/Uche.png",
    imageAlt: "Front of men's Basic Tee in black.",
    // color: "Brad Schiff",
    color: "Uchenna Nnamani",
  },
  {
    id: 6,
    ...
    imageSrc: "/assets/mentor/Ifeanyi.png",
    imageAlt: "Front of men's Basic Tee in black.",
